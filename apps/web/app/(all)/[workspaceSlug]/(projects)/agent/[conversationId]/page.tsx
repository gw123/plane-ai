...
function WorkspaceAgentConversationPage({ params }: Route.ComponentProps) {
  const { workspaceSlug, conversationId } = params;
...
export default observer(WorkspaceAgentConversationPage);
